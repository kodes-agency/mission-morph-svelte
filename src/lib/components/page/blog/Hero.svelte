...
<div bind:this={sectionEl} class="flex py-20 pt-32 flex-col items-center justify-center relative overflow-hidden">
  <img
    {src}
    {alt}
  ...
  <div class="relative z-10 items-center flex flex-col space-y-8 p-5">
    <h2 bind:this={headingEl} class="text-5xl md:text-6xl lg:text-8xl font-bold font-serif text-white text-center">
      {heading}
    </h2>
    <p bind:this={textEl} class=" text-white font-serif text-xl max-w-3xl text-center">
      {content}
    </p>
  </div>
</div>
