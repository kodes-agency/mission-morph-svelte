...
<section
  class=" bg-gradient-to-b from-cyan to-magenta h-screen flex flex-col items-center justify-center p-40 relative"
>
  ...
  {#each services as service, i}
    <div class="service absolute top-40 left-80 flex items-end" data-id={i}>
        <img
          src={PUBLIC_IMG_URL +
