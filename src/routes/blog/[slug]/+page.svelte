        ...
        <div bind:this={pinnedEl} class="flex pb-10 md:pb-0 flex-col md:w-[30vw] lg:w-[25vw] md:px-10 space-y-4">
          ...
          <div class="relative">
            ...
            <div bind:this={buttonShareWrapperEl} class="absolute invisible left-28 -top-6 md:top-auto md:left-auto flex mt-2 md:flex-col space-x-2 md:space-x-0 md:space-y-2 bg-light-cyan md:mt-2 p-4 border rounded-3xl">
              ...
              <button on:click={copyContent} class="border tiny  p-1 {isCopied ?  "bg-green text-white" : "bg-white"} text-sm rounded-full flex items-center justify-center hover:scale-95 transition-all duration-200">
